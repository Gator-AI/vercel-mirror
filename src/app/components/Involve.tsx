  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-col gap-4">
        ...
        <p className=" text-sm max-w-sm md:text-lg md:max-w-xl font-thin text-white/80 leading-snug">
          Our club has the Gator Education program to headstart your AI/ML
