      ...
      <div
        ...
        style={{
          maskImage: isHovering
            ? `radial-gradient(circle ${lensSize / 2}px at ${
                mousePosition.x
              }px ${mousePosition.y}px, transparent 100%, white 100%)`
            : "none",
          ...
          <motion.div
            ...
            style={{
              maskImage: `radial-gradient(circle ${lensSize / 2}px at ${
                position.x
              }px ${position.y}px, white 100%, transparent 100%)`,
            ...
            <div>
              <motion.div
                ...
                style={{
                  maskImage: `radial-gradient(circle ${lensSize / 2}px at ${
                    mousePosition.x
                  }px ${mousePosition.y}px, white 100%, transparent 100%)`,
                  WebkitMaskImage: `radial-gradient(circle ${
                    lensSize / 2
                  }px at ${mousePosition.x}px ${
                    mousePosition.y
                  }px, white 100%, transparent 100%)`,
