  ...
  useEffect(() => {
    if (flipped) {
      const timer = setTimeout(() => {
        setFlipped(false);
      }, 5000); // Flip back after 10 seconds
  ...
  return (
    <div className="relative perspective-1000">
      ...
      >
        {/* Front Side */}
        <motion.div
          className="absolute w-full h-full bg-gray-100 dark:bg-neutral-900 rounded-xl shadow-lg overflow-hidden"
        ...
        {/* Back Side */}
        <motion.div
          className="absolute w-full h-full bg-neutral-800 rounded-xl shadow-lg overflow-hidden flex items-center justify-center p-8"
